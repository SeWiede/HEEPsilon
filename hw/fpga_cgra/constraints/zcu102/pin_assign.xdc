...
# CLOCK
set_property -dict {PACKAGE_PIN AL8 IOSTANDARD DIFF_SSTL12} [get_ports clk_300mhz_p]
set_property -dict {PACKAGE_PIN AL7 IOSTANDARD DIFF_SSTL12} [get_ports clk_300mhz_n]
...
# LEDS
set_property -dict {PACKAGE_PIN AG14 IOSTANDARD LVCMOS33} [get_ports rst_led]
set_property -dict {PACKAGE_PIN AF13 IOSTANDARD LVCMOS33} [get_ports clk_led]
set_property -dict {PACKAGE_PIN AE13 IOSTANDARD LVCMOS33} [get_ports clk_out]
set_property -dict {PACKAGE_PIN AJ14 IOSTANDARD LVCMOS33} [get_ports exit_valid_o]
set_property -dict {PACKAGE_PIN AG13 IOSTANDARD LVCMOS33} [get_ports exit_value_o]
...
set_property -dict {PACKAGE_PIN AB4 IOSTANDARD LVCMOS18} [get_ports {gpio_io[18]}]
...
# SPI2
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS18} [get_ports {spi2_csb_io[0]}]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS18} [get_ports {spi2_csb_io[1]}]
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS18} [get_ports spi2_sck_o]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS18} [get_ports spi2_sd_0_io]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS18} [get_ports spi2_sd_1_io]
set_property -dict {PACKAGE_PIN U9 IOSTANDARD LVCMOS18} [get_ports spi2_sd_2_io]
set_property -dict {PACKAGE_PIN L11 IOSTANDARD LVCMOS18} [get_ports spi2_sd_3_io]
